...
typewriter
  .pauseFor(1000)
  .typeString('Test') //Add your own tagline
  .pauseFor(3000)
  .start()
...
//BUTTON 3 -- links to outside website
var btn_conf1 = document.getElementById("btn_conf1");
btn_conf1.onclick = function() { 
  window.open("https://pittcon.org/exhibit-now/", "_blank") //TODO add your link
}