...
typewriter
  .pauseFor(1000)
  .typeString('Welcome to my page!') //Add your own tagline
  .pauseFor(3000)
  .start()
...
//BUTTON HOBBY 7
var modalHobby7 = document.getElementById("modalHobby7");

// Get the button that opens the modal
var btnHobby7 = document.getElementById("hobbyBtn7");

// Get the <span> element that closes the modal
var spanModalHobby7 = document.getElementsByClassName("closeModalHobby7")[0];

// When the user clicks on the button, open the modal
btnHobby7.onclick = function() {
  modalHobby7.style.display = "block";
}

// When the user clicks on <span> (x), close the modal
spanModalHobby7.onclick = function() {
  modalHobby7.style.display = "none";
}

// When the user clicks anywhere outside of the modal, close it
window.onclick = function(event) {
  if (event.target == modalHobby7) {
    modalHobby7.style.display = "none";
  }
}
